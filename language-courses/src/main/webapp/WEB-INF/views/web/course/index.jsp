			...
			<div class="col-lg-8">
				<div class="section-title text-center position-relative mb-5">
					<h6
						...
						học</h6>
					<h1 class="display-4">Chất lượng và luôn được cập nhật liên
						tục</h1>
				</div>
			</div>
		</div>
			...
			<div class="col-12">
				<nav aria-label="Page navigation">
					<ul class="pagination pagination-lg justify-content-center mb-0">
						...
						<li class="page-item"><a class="page-link rounded-0" href="#"
