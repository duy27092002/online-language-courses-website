	...
	<div class="container-fluid py-5">
		<div class="container py-5">
			...
			<div class="owl-carousel team-carousel position-relative"
				...
				<div class="team-item">
					<img class="img-fluid w-100" src="/web/img/team-1.jpg" alt="">
					<div class="bg-light text-center p-4">
						<h5 class="mb-3">Instructor Name</h5>
						<p class="mb-2">Web Design & Development</p>
						<div class="d-flex justify-content-center">
							<a class="mx-1 p-1" href="#"><i class="fab fa-twitter"></i></a> <a
								class="mx-1 p-1" href="#"><i class="fab fa-facebook-f"></i></a>
				...
				<div class="team-item">
					<img class="img-fluid w-100" src="/web/img/team-2.jpg" alt="">
					<div class="bg-light text-center p-4">
						<h5 class="mb-3">Instructor Name</h5>
						<p class="mb-2">Web Design & Development</p>
						<div class="d-flex justify-content-center">
				...
				<div class="team-item">
					<img class="img-fluid w-100" src="/web/img/team-3.jpg" alt="">
					<div class="bg-light text-center p-4">
						<h5 class="mb-3">Instructor Name</h5>
						<p class="mb-2">Web Design & Development</p>
						<div class="d-flex justify-content-center">
				...
				<div class="team-item">
					<img class="img-fluid w-100" src="/web/img/team-4.jpg" alt="">
					<div class="bg-light text-center p-4">
						<h5 class="mb-3">Instructor Name</h5>
						<p class="mb-2">Web Design & Development</p>
						<div class="d-flex justify-content-center">
