...
<div id="content">
	...
	<div class="container-fluid">
		<h1 class="text-center">Thông tin chi tiết ngôn ngữ</h1>
							...
							<f:form cssClass="user">
								<div class="form-group row">
									<div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-3 mb-sm-0">
										<label>Tên ngôn ngữ:</label> <input
											class="form-control form-control-user bg-white"
											value="${languageDetails.name}" disabled="disabled" />
									</div>
									<div class="col-12 col-sm-12 col-md-6 col-lg-6">
										<c:if test="${languageDetails.status == 1 }">
											<c:set var="status" value="Đang hoạt động"></c:set>
										</c:if>
										<c:if test="${languageDetails.status == 0 }">
								...
								<p class="mb-0">
									<small>Cập nhật bởi: ${languageDetails.modifiedBy}</small>
								</p>
								<small>Vào lúc: <fmt:formatDate
										value="${languageDetails.modifiedDate}"
										pattern="HH:mm:ss dd/MM/yyyy" /></small>
								<div class="form-group row">
									<div class="col-12 col-sm-12 col-md-6 col-lg-6">
										<a
											href="/quan-tri/ngon-ngu/chinh-sua?id=${languageDetails.id}"
