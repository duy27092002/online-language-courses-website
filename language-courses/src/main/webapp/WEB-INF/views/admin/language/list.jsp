		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<a class="btn btn-sm btn-primary mb-4"
					href="/quan-tri/ngon-ngu/them-moi"><i class="fas fa-plus mr-2"></i>Thêm
					mới</a>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<form action="/quan-tri/ngon-ngu/danh-sach" method="get"
						...
						<thead>
							<tr>
								...
								<th scope="col"><a
									...
									class="text-body" style="text-decoration: none;">Tên ngôn
										ngữ <i class="fas fa-arrows-alt-v ml-1"></i>
								</a></th>
