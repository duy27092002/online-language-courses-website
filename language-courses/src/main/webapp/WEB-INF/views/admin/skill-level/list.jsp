...
<div id="content">
	...
	<div class="container-fluid">
		<h1 class="text-center">Danh sách kỹ năng</h1>
		<c:if test="${mess != null}">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<a class="btn btn-sm btn-primary mb-4"
					href="/quan-tri/ky-nang/them-moi"><i class="fas fa-plus mr-2"></i>Thêm
					mới</a>
			</div>
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<form action="/quan-tri/ky-nang/danh-sach" method="get"
					class="float-sm-left float-md-right float-lg-right form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					<div class="input-group">
						<input name="keyword" type="text"
							class="form-control bg-light small" maxlength="20"
						...
						<thead>
							<tr>
								...
								<th scope="col"><a
									...
									class="text-body" style="text-decoration: none;">Tên kỹ
										năng <i class="fas fa-arrows-alt-v ml-1"></i>
								</a></th>
