	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-12 col-sm-12 col-md-6 col-lg-6">
				<form action="/quan-tri/khoa-hoc-cua-toi" method="get"
							...
							<tr>
								<c:if test="${resultList.keyword == null}">
									<c:set var="pagingParam"
										value="id=${instructorId}&orderBy=name&orderType=${orderType}"></c:set>
								</c:if>
								<c:if test="${resultList.keyword != null}">
									<c:set var="pagingParam"
										value="id=${instructorId}&keyword=${resultList.keyword}&orderBy=name&orderType=${orderType}"></c:set>
								</c:if>
